...
public class SkierServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        jsonMessage.addProperty("seasonID", RequestValidator.extractSeason(urlPath));
        jsonMessage.addProperty("resortID", RequestValidator.extractResortID(urlPath));
        jsonMessage.addProperty("dayID", RequestValidator.extractDay(urlPath));
